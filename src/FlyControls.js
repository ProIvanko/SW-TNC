import {THREE} from './three_libs_import.js';
...
class FlyControls extends THREE.EventDispatcher {
	...
	constructor( object, domElement ) {
        ...
        this.gamepadDataUpdate =  function(gamePadUnit){

			if (gamePadUnit.gamepad.id) {
                this.moveState.yawLeft = -gamePadUnit.gamepad.axes[0];
				this.moveState.pitchDown = gamePadUnit.gamepad.axes[1];
                this.moveState.rollLeft = gamePadUnit.gamepad.axes[2];
                this.moveState.rollLeft = -gamePadUnit.gamepad.axes[2];
				this.updateRotationVector();
			}
		};
        //---Конец дописанной части-----
		...
		this.update = function ( delta ) {
            //Добавленный код 
            if(gamePadUnit.gamepad.id){
                this.gamepadDataUpdate(gamePadUnit);
            }
